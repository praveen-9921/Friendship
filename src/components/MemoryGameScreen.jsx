...
export default function MemoryGameScreen({ onGameComplete, gameCompleted }) {
  ...
  // Friendship-themed game symbols
  const gameSymbols = ["🤝", "💕", "🎉", "✨", "🌟", "🎈"]
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex justify-between items-center">
          ...
          <div className="bg-black/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-pink-500/30">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-bold">{matchedCards.length}/12</span>
            </div>
          </div>
        </div>
      )}
        ...
        {gameCompleted && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-yellow-400 to-pink-500 bg-clip-text text-transparent">
                Amazing Bestie!
              </h2>
              <p className="text-gray-300 text-xl mb-2">Completed in {moves} moves!</p>
              <p className="text-gray-400">Opening your memory album...</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
